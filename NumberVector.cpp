...
static unsigned char COUNT_PRESENT[1ul << 10ul]   = {0};
static unsigned char COUNT_MISSING[1ul << 10ul]   = {0};
static unsigned char SMALLEST_NUMBER[1ul << 10ul] = {0};
...
unsigned char NumberVector::count() const {
    return COUNT_PRESENT[m_numberBits];
}

unsigned char NumberVector::missing() const {
...
unsigned char NumberVector::smallestNumber() const {
